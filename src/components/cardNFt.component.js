    ...
    render() {
        return html`
            <article class="container">
                ...
                <div class="footer">
                    <button class="btnTime"><img src="${clock}" alt="time"/><span>${this.time}</span></button> 
                    <button class="btnPlace"><img src="${crow}" alt="crows"/><span>Place Bid </span></button> 
                </div>
            </article>
        `;
    }
